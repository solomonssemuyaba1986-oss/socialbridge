                  ...
                  {products.map((product) => {
                    ...
                    return (
                      <div key={product.id} style={{ background: '#1a1a1a', border: '1px solid #222', borderRadius: '14px', padding: '12px', display: 'flex', gap: '12px', alignItems: 'flex-start', position: 'relative' }}>
                        <span style={{ position: 'absolute', top: '6px', left: '6px', background: green, color: '#000', padding: '1px 5px', borderRadius: '3px', fontSize: '9px', fontWeight: '800', zIndex: 2 }}>Yours</span>
